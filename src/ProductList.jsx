        ...
        <div className="product-grid">
            ...
            {item.plants.map((plant)=>
                <div className='product-card'>
                    ...
                    <p>{plant.cost}</p>
                    <button style={{backgroundColor:alreadyInCart(plant.name)?"gray":"#FFFFFF"}} disabled={alreadyInCart(plant.name)? true:false} onClick={()=>handleAddToCart({name:plant.name,cost:plant.cost,image:plant.image})} className='product-button'>Add to Cart</button>
                </div>)}
                 </div>
            </div>)}
